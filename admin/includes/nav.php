<nav class="navbar bg-secondary navbar-dark">
                ...
                <a href="index.php" class="nav-item nav-link active"><i class="fa fa-tachometer-alt me-2"></i>Dashboard</a>
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fa fa-plus me-2"></i>Add Items</a>
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="slideshow.php" class="dropdown-item">Slideshow</a>
                        </div>
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="element.php" class="dropdown-item">Add Product</a>
                            <a href="element.php" class="dropdown-item">View Product</a>
                        </div>
                        <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="categories.php" class="dropdown-item">View Categories</a>
                        </div>

                        <!-- Product add and view -->
                        <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fa fa-rectangle-history-circle-plus me-2"></i>Products</a>
                        <div class="dropdown-menu bg-transparent border-0">
